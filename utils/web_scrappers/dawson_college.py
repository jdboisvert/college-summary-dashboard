...
class DawsonCollegeWebsiteScrapper:
    ...
    def get_programs(self) -> List[Program]:
        ...
        for listed_program in listed_programs:
            ...
            try:
                programs.append(self.__get_program_details(program_url=program_url, listed_program=listed_program))
    ...
    def scrap(self):
        ...
        number_of_disciplines = self.__get_number_of_type(programs_data_frame, 'Discipline')
        number_of_special_studies = self.__get_number_of_type(programs_data_frame, 'Special Area of Study')
        number_of_general_education = self.__get_number_of_type(programs_data_frame, 'General Education')
